...
import math
from paddle.fluid.dygraph import Layer, Conv2D, BatchNorm
...
def batchNorm2d(planes):
    return BatchNorm(planes, act="relu")
...
class BasicBlock(Layer):
    ...
    def __init__(self, name_scope=namescope ,inplanes, planes, stride=1, downsample=None):
        super(BasicBlock, self).__init__(namescope)
